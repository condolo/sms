/* ============================================================
   SchoolSync — Browser Test Layer
   Dev-mode only.  Activate by opening the app with ?tests=1
   in the URL, or call SchoolSyncTests.run() in the console.
...
const SchoolSyncTests = (() => {
  ...
  function _testDB() {
    console.group('[SchoolSync Tests] DB Layer');
  ...
  function _testSchoolContext() {
    console.group('[SchoolSync Tests] SchoolContext');
  ...
  function _testGlobalUtils() {
    console.group('[SchoolSync Tests] Global Utilities');
  ...
  function _testSeedData() {
    console.group('[SchoolSync Tests] Seed Data Integrity');
  ...
  function _testAuditLog() {
    console.group('[SchoolSync Tests] Audit Log');

    const before = DB.get('audit_log').length;
    _audit('TEST_ACTION', { source: 'SchoolSyncTests', value: 'ok' });
    ...
    _check('audit entry has details',               entry?.details?.source === 'SchoolSyncTests');
  ...
  function _testBehaviourModule() {
    console.group('[SchoolSync Tests] Behaviour Module');
  ...
  function _testENUMS() {
    console.group('[SchoolSync Tests] ENUMS');
  ...
  function _testValidators() {
    console.group('[SchoolSync Tests] Validators');
  ...
  function run() {
    _passed = 0;
    _failed = 0;
    console.group('%c[SchoolSync Tests] Running test suite…', 'font-weight:bold;color:#2563EB');
...
if (location.search.includes('tests=1')) {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(() => SchoolSyncTests.run(), 800);
  });
}
