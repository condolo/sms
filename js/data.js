/* ============================================================
   SchoolSync — Data Layer (DB + Seed Data)
   All data stored in localStorage, keyed by collection name.
   ============================================================ */
...
const DB = (() => {
  ...
  function seed() {
    ...
    set('schools', [{
      ...
      email: 'info@meridian.edu.ke',
      website: 'www.meridian.edu.ke',
      logo: null,
    ...
    set('users', [
      /* ── SUPER ADMIN ── */
      { id:'u_super',  schoolId:'sch1', role:'superadmin', primaryRole:'superadmin', roles:['superadmin'], name:'System Administrator', email:'superadmin@meridian.edu.ke', password:'super123', phone:'+254 722 000 000', avatar:null, isActive:true, lastLogin:'2025-04-23T08:00:00Z', createdAt:'2020-01-01T00:00:00Z' },
      /* ── PRINCIPAL / ADMIN ── */
      { id:'u_admin1', schoolId:'sch1', role:'admin', primaryRole:'admin', roles:['admin'], name:'Mwalimu Ndolo', email:'admin@meridian.edu.ke', password:'admin123', phone:'+254 722 000 001', avatar:null, isActive:true, lastLogin:'2025-04-23T08:00:00Z', createdAt:'2020-01-01T00:00:00Z' },
      { id:'u_admin2', schoolId:'sch1', role:'admin', primaryRole:'admin', roles:['admin'], name:'Mr. David Kariuki', email:'vice@meridian.edu.ke', password:'admin123', phone:'+254 722 000 002', avatar:null, isActive:true, lastLogin:'2025-04-22T09:00:00Z', createdAt:'2020-01-01T00:00:00Z' },
      /* ── SECTION HEADS ── */
      { id:'u_sh_kg',  schoolId:'sch1', role:'section_head', primaryRole:'section_head', roles:['section_head'], name:'Ms. Rose Akinyi', email:'head.kg@meridian.edu.ke', password:'section123', phone:'+254 722 010 001', avatar:null, isActive:true, sectionId:'sec_kg',  lastLogin:'2025-04-23T07:30:00Z', createdAt:'2021-01-01T00:00:00Z' },
      { id:'u_sh_pri', schoolId:'sch1', role:'section_head', primaryRole:'section_head', roles:['section_head'], name:'Mr. Collins Kimani', email:'head.primary@meridian.edu.ke', password:'section123', phone:'+254 722 010 002', avatar:null, isActive:true, sectionId:'sec_pri', lastLogin:'2025-04-23T07:35:00Z', createdAt:'2021-01-01T00:00:00Z' },
      { id:'u_sh_sec', schoolId:'sch1', role:'section_head', primaryRole:'section_head', roles:['section_head','teacher'], name:'Dr. Amira Osei', email:'head.secondary@meridian.edu.ke', password:'section123', phone:'+254 722 010 003', avatar:null, isActive:true, sectionId:'sec_sec', lastLogin:'2025-04-23T07:40:00Z', createdAt:'2020-08-01T00:00:00Z' },
      /* ── TIMETABLER ── */
      { id:'u_ttbl1', schoolId:'sch1', role:'timetabler', primaryRole:'timetabler', roles:['timetabler'], name:'Mr. Kevin Njoroge', email:'timetabler@meridian.edu.ke', password:'timetable123', phone:'+254 722 010 010', avatar:null, isActive:true, lastLogin:'2025-04-23T07:50:00Z', createdAt:'2023-01-01T00:00:00Z' },
      /* ── DEPUTY PRINCIPAL ── */
      { id:'u_dp1',   schoolId:'sch1', role:'deputy_principal', primaryRole:'deputy_principal', roles:['deputy_principal'], name:'Mr. Thomas Wangila', email:'deputy@meridian.edu.ke', password:'deputy123', phone:'+254 722 010 020', avatar:null, isActive:true, lastLogin:'2025-04-23T07:45:00Z', createdAt:'2021-01-01T00:00:00Z' },
      /* ── DISCIPLINE COMMITTEE ── */
      { id:'u_dc1',   schoolId:'sch1', role:'discipline_committee', primaryRole:'discipline_committee', roles:['discipline_committee'], name:'Mrs. Patricia Nduta', email:'discipline@meridian.edu.ke', password:'discipline123', phone:'+254 722 010 021', avatar:null, isActive:true, lastLogin:'2025-04-23T07:50:00Z', createdAt:'2022-01-01T00:00:00Z' },
      /* ── ADMISSIONS OFFICER ── */
      { id:'u_adm1',   schoolId:'sch1', role:'admissions_officer', primaryRole:'admissions_officer', roles:['admissions_officer'], name:'Ms. Joy Wambua', email:'admissions@meridian.edu.ke', password:'admissions123', phone:'+254 722 020 001', avatar:null, isActive:true, lastLogin:'2025-04-23T08:15:00Z', createdAt:'2022-01-01T00:00:00Z' },
      /* ── TEACHERS (u_tch1 = Sarah Smith is also exams_officer — multi-role demo) ── */
      { id:'u_tch1',  schoolId:'sch1', role:'teacher', primaryRole:'teacher', roles:['teacher','exams_officer'], name:'Ms. Sarah Smith', email:'sarah.smith@meridian.edu.ke', password:'teacher123', phone:'+254 722 100 001', avatar:null, isActive:true, lastLogin:'2025-04-23T07:45:00Z', createdAt:'2021-01-01T00:00:00Z' },
      { id:'u_tch2',  schoolId:'sch1', role:'teacher', primaryRole:'teacher', roles:['teacher'], name:'Mr. James Ochieng', email:'james.ochieng@meridian.edu.ke', password:'teacher123', phone:'+254 722 100 002', avatar:null, isActive:true, lastLogin:'2025-04-23T07:50:00Z', createdAt:'2021-01-01T00:00:00Z' },
      { id:'u_tch3',  schoolId:'sch1', role:'teacher', primaryRole:'teacher', roles:['teacher'], name:'Ms. Priya Wanjiru', email:'priya.wanjiru@meridian.edu.ke', password:'teacher123', phone:'+254 722 100 003', avatar:null, isActive:true, lastLogin:'2025-04-22T07:30:00Z', createdAt:'2021-06-01T00:00:00Z' },
      { id:'u_tch4',  schoolId:'sch1', role:'teacher', primaryRole:'teacher', roles:['teacher'], name:'Dr. Ahmed Hassan', email:'ahmed.hassan@meridian.edu.ke', password:'teacher123', phone:'+254 722 100 004', avatar:null, isActive:true, lastLogin:'2025-04-23T08:10:00Z', createdAt:'2020-08-01T00:00:00Z' },
      { id:'u_tch5',  schoolId:'sch1', role:'teacher', primaryRole:'teacher', roles:['teacher'], name:'Mrs. Grace Kamau', email:'grace.kamau@meridian.edu.ke', password:'teacher123', phone:'+254 722 100 005', avatar:null, isActive:true, lastLogin:'2025-04-22T15:00:00Z', createdAt:'2022-01-01T00:00:00Z' },
      { id:'u_tch6',  schoolId:'sch1', role:'teacher', primaryRole:'teacher', roles:['teacher'], name:'Mr. Raj Patel', email:'raj.patel@meridian.edu.ke', password:'teacher123', phone:'+254 722 100 006', avatar:null, isActive:true, lastLogin:'2025-04-21T08:00:00Z', createdAt:'2022-06-01T00:00:00Z' },
      { id:'u_tch7',  schoolId:'sch1', role:'teacher', primaryRole:'teacher', roles:['teacher'], name:'Ms. Fatuma Ngugi', email:'fatuma.ngugi@meridian.edu.ke', password:'teacher123', phone:'+254 722 100 007', avatar:null, isActive:true, lastLogin:'2025-04-23T07:55:00Z', createdAt:'2023-01-01T00:00:00Z' },
      { id:'u_tch8',  schoolId:'sch1', role:'teacher', primaryRole:'teacher', roles:['teacher'], name:'Mr. Kevin Otieno', email:'kevin.otieno@meridian.edu.ke', password:'teacher123', phone:'+254 722 100 008', avatar:null, isActive:true, lastLogin:'2025-04-22T09:00:00Z', createdAt:'2023-06-01T00:00:00Z' },
      /* ── FINANCE ── */
      { id:'u_fin1',  schoolId:'sch1', role:'finance', primaryRole:'finance', roles:['finance'], name:'Ms. Nancy Njeri', email:'finance@meridian.edu.ke', password:'finance123', phone:'+254 722 200 001', avatar:null, isActive:true, lastLogin:'2025-04-23T08:30:00Z', createdAt:'2020-01-01T00:00:00Z' },
      /* ── HR ── */
      { id:'u_hr1',   schoolId:'sch1', role:'hr', primaryRole:'hr', roles:['hr'], name:'Mr. Peter Muthoni', email:'hr@meridian.edu.ke', password:'hr123', phone:'+254 722 030 001', avatar:null, isActive:true, lastLogin:'2025-04-22T09:00:00Z', createdAt:'2021-06-01T00:00:00Z' },
      /* ── PARENTS ── */
      { id:'u_par1',  schoolId:'sch1', role:'parent', primaryRole:'parent', roles:['parent'], name:'Mr. & Mrs. Johnson', email:'parent1@meridian.edu.ke', password:'parent123', phone:'+254 722 300 001', avatar:null, isActive:true, lastLogin:'2025-04-22T20:00:00Z', createdAt:'2022-01-01T00:00:00Z' },
      { id:'u_par2',  schoolId:'sch1', role:'parent', primaryRole:'parent', roles:['parent'], name:'Mrs. Achieng Omondi', email:'parent2@meridian.edu.ke', password:'parent123', phone:'+254 722 300 002', avatar:null, isActive:true, lastLogin:'2025-04-21T19:00:00Z', createdAt:'2022-01-01T00:00:00Z' },
      { id:'u_par3',  schoolId:'sch1', role:'parent', primaryRole:'parent', roles:['parent'], name:'Dr. Suresh Patel', email:'parent3@meridian.edu.ke', password:'parent123', phone:'+254 722 300 003', avatar:null, isActive:true, lastLogin:'2025-04-20T18:00:00Z', createdAt:'2022-06-01T00:00:00Z' },
      { id:'u_par4',  schoolId:'sch1', role:'parent', primaryRole:'parent', roles:['parent'], name:'Ms. Wanjiku Mwangi', email:'parent4@meridian.edu.ke', password:'parent123', phone:'+254 722 300 004', avatar:null, isActive:true, lastLogin:'2025-04-19T18:00:00Z', createdAt:'2023-01-01T00:00:00Z' },
      /* ── STUDENTS ── */
      { id:'u_stu1',  schoolId:'sch1', role:'student', primaryRole:'student', roles:['student'], name:'Emily Johnson', email:'student1@meridian.edu.ke', password:'student123', phone:'+254 722 400 001', avatar:null, isActive:true, lastLogin:'2025-04-23T07:00:00Z', createdAt:'2022-01-10T00:00:00Z' },
      { id:'u_stu2',  schoolId:'sch1', role:'student', primaryRole:'student', roles:['student'], name:'Brian Omondi', email:'student2@meridian.edu.ke', password:'student123', phone:'+254 722 400 002', avatar:null, isActive:true, lastLogin:'2025-04-23T07:05:00Z', createdAt:'2022-01-10T00:00:00Z' },
      { id:'u_stu3',  schoolId:'sch1', role:'student', primaryRole:'student', roles:['student'], name:'Anika Patel', email:'student3@meridian.edu.ke', password:'student123', phone:'+254 722 400 003', avatar:null, isActive:true, lastLogin:'2025-04-22T17:00:00Z', createdAt:'2022-06-10T00:00:00Z' },
      { id:'u_stu4',  schoolId:'sch1', role:'student', primaryRole:'student', roles:['student'], name:'Kevin Mwangi', email:'student4@meridian.edu.ke', password:'student123', phone:'+254 722 400 004', avatar:null, isActive:true, lastLogin:'2025-04-23T07:10:00Z', createdAt:'2023-01-10T00:00:00Z' }
    ]);
    ...
    /* TEACHERS */
    set('teachers', [
      { id: 'tch1', schoolId: 'sch1', userId: 'u_tch1', staffId: 'MIS-TCH-001', firstName: 'Sarah', lastName: 'Smith', gender: 'Female', dateOfBirth: '1985-03-12', nationality: 'British', qualification: 'M.Ed English Literature', specialization: 'English Language & Literature', subjects: ['sbj1','sbj11'], homeroomClass: 'cls7a', joinDate: '2021-01-10', contractType: 'permanent', status: 'active', salary: 180000, workloadHours: 24, phone: '+254 722 100 001', email: 'sarah.smith@meridian.edu.ke', address: 'Kilimani, Nairobi', emergencyContact: 'John Smith +44 7700 900 000', createdAt: '2021-01-10T00:00:00Z' },
      { id: 'tch2', schoolId: 'sch1', userId: 'u_tch2', staffId: 'MIS-TCH-002', firstName: 'James', lastName: 'Ochieng', gender: 'Male', dateOfBirth: '1980-07-22', nationality: 'Kenyan', qualification: 'B.Sc Mathematics, PGCE', specialization: 'Pure & Applied Mathematics', subjects: ['sbj2','sbj14'], homeroomClass: 'cls7b', joinDate: '2021-01-10', contractType: 'permanent', status: 'active', salary: 165000, workloadHours: 26, phone: '+254 722 100 002', email: 'james.ochieng@meridian.edu.ke', address: 'South B, Nairobi', emergencyContact: 'Mary Ochieng +254 722 500 001', createdAt: '2021-01-10T00:00:00Z' },
      { id: 'tch3', schoolId: 'sch1', userId: 'u_tch3', staffId: 'MIS-TCH-003', firstName: 'Priya', lastName: 'Wanjiru', gender: 'Female', dateOfBirth: '1988-11-05', nationality: 'Indian-Kenyan', qualification: 'M.Sc Biology', specialization: 'Life Sciences & Environmental Studies', subjects: ['sbj3','sbj7'], homeroomClass: 'cls8a', joinDate: '2021-06-01', contractType: 'permanent', status: 'active', salary: 160000, workloadHours: 22, phone: '+254 722 100 003', email: 'priya.wanjiru@meridian.edu.ke', address: 'Karen, Nairobi', emergencyContact: 'Raj Wanjiru +254 722 500 002', createdAt: '2021-06-01T00:00:00Z' },
      { id: 'tch4', schoolId: 'sch1', userId: 'u_tch4', staffId: 'MIS-TCH-004', firstName: 'Ahmed', lastName: 'Hassan', gender: 'Male', dateOfBirth: '1975-02-18', nationality: 'Somali-Kenyan', qualification: 'PhD Physics', specialization: 'Physics & Chemistry', subjects: ['sbj4','sbj5'], homeroomClass: 'cls8b', joinDate: '2020-08-01', contractType: 'permanent', status: 'active', salary: 210000, workloadHours: 20, phone: '+254 722 100 004', email: 'ahmed.hassan@meridian.edu.ke', address: 'Eastleigh, Nairobi', emergencyContact: 'Halima Hassan +254 722 500 003', createdAt: '2020-08-01T00:00:00Z' },
      { id: 'tch5', schoolId: 'sch1', userId: 'u_tch5', staffId: 'MIS-TCH-005', firstName: 'Grace', lastName: 'Kamau', gender: 'Female', dateOfBirth: '1990-09-14', nationality: 'Kenyan', qualification: 'B.A History, PGCE', specialization: 'History & Social Studies', subjects: ['sbj6','sbj12'], homeroomClass: 'cls9a', joinDate: '2022-01-10', contractType: 'permanent', status: 'active', salary: 145000, workloadHours: 24, phone: '+254 722 100 005', email: 'grace.kamau@meridian.edu.ke', address: 'Westlands, Nairobi', emergencyContact: 'Peter Kamau +254 722 500 004', createdAt: '2022-01-10T00:00:00Z' },
      { id: 'tch6', schoolId: 'sch1', userId: 'u_tch6', staffId: 'MIS-TCH-006', firstName: 'Raj', lastName: 'Patel', gender: 'Male', dateOfBirth: '1983-04-30', nationality: 'Indian', qualification: 'M.Sc Computer Science', specialization: 'Computer Science & ICT', subjects: ['sbj8'], homeroomClass: 'cls9b', joinDate: '2022-06-01', contractType: 'contract', status: 'active', salary: 175000, workloadHours: 20, phone: '+254 722 100 006', email: 'raj.patel@meridian.edu.ke', address: 'Parklands, Nairobi', emergencyContact: 'Meena Patel +254 722 500 005', createdAt: '2022-06-01T00:00:00Z' },
      { id: 'tch7', schoolId: 'sch1', userId: 'u_tch7', staffId: 'MIS-TCH-007', firstName: 'Fatuma', lastName: 'Ngugi', gender: 'Female', dateOfBirth: '1992-06-08', nationality: 'Kenyan', qualification: 'B.A Business, CPA', specialization: 'Business Studies & Economics', subjects: ['sbj13','sbj14'], homeroomClass: 'cls10a', joinDate: '2023-01-10', contractType: 'permanent', status: 'active', salary: 140000, workloadHours: 22, phone: '+254 722 100 007', email: 'fatuma.ngugi@meridian.edu.ke', address: 'Embakasi, Nairobi', emergencyContact: 'Hassan Ngugi +254 722 500 006', createdAt: '2023-01-10T00:00:00Z' },
      { id: 'tch8', schoolId: 'sch1', userId: 'u_tch8', staffId: 'MIS-TCH-008', firstName: 'Kevin', lastName: 'Otieno', gender: 'Male', dateOfBirth: '1987-12-20', nationality: 'Kenyan', qualification: 'B.Ed Physical Education', specialization: 'Physical Education & Sports', subjects: ['sbj9','sbj10'], homeroomClass: 'cls10b', joinDate: '2023-06-01', contractType: 'permanent', status: 'active', salary: 130000, workloadHours: 28, phone: '+254 722 100 008', email: 'kevin.otieno@meridian.edu.ke', address: 'Langata, Nairobi', emergencyContact: 'Jane Otieno +254 722 500 007', createdAt: '2023-06-01T00:00:00Z' }
    ]);
    ...
    set('students', [
      /* Grade 10A */
      { id: 'stu1',  schoolId: 'sch1', userId: 'u_stu1', admissionNo: 'MIS-2022-001', firstName: 'Emily',   lastName: 'Johnson',  gender: 'Female', dateOfBirth: '2010-03-15', nationality: 'British',  bloodGroup: 'O+',  classId: 'cls10a', status: 'active', enrollmentDate: '2022-01-10', photo: null, enrolledSubjectIds: ['sbj1','sbj2','sbj5','sbj8','sbj9','sbj12'], guardians: [{userId:'u_par1', name:'Mr. & Mrs. Johnson', relation:'Parents', phone:'+254 722 300 001', email:'parent1@meridian.edu.ke', isPrimary:true}], medicalInfo: {conditions:'Mild asthma', allergies:'Pollen', medications:'Ventolin inhaler (as needed)', doctorName:'Dr. Otieno', doctorPhone:'+254 722 600 001', emergencyContact:'+254 722 300 001'}, createdAt:'2022-01-10T00:00:00Z' },
      { id: 'stu2',  schoolId: 'sch1', userId: 'u_stu2', admissionNo: 'MIS-2022-002', firstName: 'Brian',   lastName: 'Omondi',   gender: 'Male',   dateOfBirth: '2010-07-04', nationality: 'Kenyan',   bloodGroup: 'A+',  classId: 'cls10a', status: 'active', enrollmentDate: '2022-01-10', photo: null, enrolledSubjectIds: ['sbj1','sbj2','sbj5','sbj8','sbj9','sbj12'], guardians: [{userId:'u_par2', name:'Mrs. Achieng Omondi', relation:'Mother', phone:'+254 722 300 002', email:'parent2@meridian.edu.ke', isPrimary:true}], medicalInfo: {conditions:'None', allergies:'None', medications:'None', doctorName:'Dr. Njoroge', doctorPhone:'+254 722 600 002', emergencyContact:'+254 722 300 002'}, createdAt:'2022-01-10T00:00:00Z' },
      ...
      { id: 'stu4',  schoolId: 'sch1', admissionNo: 'MIS-2022-004', firstName: 'Ethan',   lastName: 'Mwangi',   gender: 'Male',   dateOfBirth: '2010-09-11', nationality: 'Kenyan',   bloodGroup: 'AB+', classId: 'cls10a', status: 'active', enrollmentDate: '2022-01-10', photo: null, enrolledSubjectIds: ['sbj1','sbj2','sbj4','sbj14','sbj9','sbj12'], guardians: [{name:'Mrs. Wanjiku Mwangi', relation:'Mother', phone:'+254 722 302 001', email:'parent4@meridian.edu.ke', isPrimary:true}], medicalInfo: {conditions:'None', allergies:'Nuts', medications:'EpiPen', doctorName:'Dr. Kamau', doctorPhone:'+254 722 600 004', emergencyContact:'+254 722 302 001'}, createdAt:'2022-01-10T00:00:00Z' },
      /* Grade 10B */
      { id: 'stu5',  schoolId: 'sch1', userId: 'u_stu3', admissionNo: 'MIS-2022-005', firstName: 'Anika',   lastName: 'Patel',    gender: 'Female', dateOfBirth: '2010-05-28', nationality: 'Indian',   bloodGroup: 'O-',  classId: 'cls10b', status: 'active', enrollmentDate: '2022-06-10', photo: null, enrolledSubjectIds: ['sbj1','sbj2','sbj3','sbj4','sbj9','sbj12'], guardians: [{userId:'u_par3', name:'Dr. Suresh Patel', relation:'Father', phone:'+254 722 300 003', email:'parent3@meridian.edu.ke', isPrimary:true}], medicalInfo: {conditions:'None', allergies:'None', medications:'None', doctorName:'Dr. Sharma', doctorPhone:'+254 722 600 005', emergencyContact:'+254 722 300 003'}, createdAt:'2022-06-10T00:00:00Z' },
      ...
      { id: 'stu12', schoolId: 'sch1', userId: 'u_stu4', admissionNo: 'MIS-2023-005', firstName: 'Kevin',   lastName: 'Mwangi',   gender: 'Male',   dateOfBirth: '2011-10-30', nationality: 'Kenyan',   bloodGroup: 'AB+', classId: 'cls9b',  status: 'active', enrollmentDate: '2023-01-10', photo: null, enrolledSubjectIds: ['sbj1','sbj2','sbj5','sbj8','sbj9','sbj12'], guardians: [{userId:'u_par4', name:'Ms. Wanjiku Mwangi', relation:'Mother', phone:'+254 722 300 004', email:'parent4@meridian.edu.ke', isPrimary:true}], medicalInfo: {conditions:'None', allergies:'None', medications:'None', doctorName:'Dr. Muriu', doctorPhone:'+254 722 600 012', emergencyContact:'+254 722 300 004'}, createdAt:'2023-01-10T00:00:00Z' },
      /* Grade 8A */
    ...
    set('admission_settings', [{
      ...
      onlineFormTitle:   'Apply to Meridian International School',
    ...
    _markSeeded();
    console.log('SchoolSync seed data loaded (v' + SEED_VERSION + ').');
  }
