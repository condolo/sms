...
const DB = (() => {
  ...
  function seed() {
    ...
    set('students', [
      /* Grade 10A */
      { id: 'stu1',  schoolId: 'sch1', userId: 'u_stu1', admissionNo: 'MIS-2022-001', firstName: 'Emily',   lastName: 'Johnson',  gender: 'Female', dateOfBirth: '2010-04-28', nationality: 'British',  bloodGroup: 'O+',  classId: 'cls10a', status: 'active', enrollmentDate: '2022-01-10', photo: null, enrolledSubjectIds: ['sbj1','sbj2','sbj5','sbj8','sbj9','sbj12'], guardians: [{userId:'u_par1', name:'Mr. & Mrs. Johnson', relation:'Parents', phone:'+254 722 300 001', email:'parent1@meridian.edu.ke', isPrimary:true}], medicalInfo: {conditions:'Mild asthma', allergies:'Pollen', medications:'Ventolin inhaler (as needed)', doctorName:'Dr. Otieno', doctorPhone:'+254 722 600 001', emergencyContact:'+254 722 300 001'}, createdAt:'2022-01-10T00:00:00Z' },
      { id: 'stu2',  schoolId: 'sch1', userId: 'u_stu2', admissionNo: 'MIS-2022-002', firstName: 'Brian',   lastName: 'Omondi',   gender: 'Male',   dateOfBirth: '2010-04-29', nationality: 'Kenyan',   bloodGroup: 'A+',  classId: 'cls10a', status: 'active', enrollmentDate: '2022-01-10', photo: null, enrolledSubjectIds: ['sbj1','sbj2','sbj5','sbj8','sbj9','sbj12'], guardians: [{userId:'u_par2', name:'Mrs. Achieng Omondi', relation:'Mother', phone:'+254 722 300 002', email:'parent2@meridian.edu.ke', isPrimary:true}], medicalInfo: {conditions:'None', allergies:'None', medications:'None', doctorName:'Dr. Njoroge', doctorPhone:'+254 722 600 002', emergencyContact:'+254 722 300 002'}, createdAt:'2022-01-10T00:00:00Z' },
