/* ============================================================
   InnoLearn — Behaviour & Pastoral Module  v2
...
<head>
<meta charset="UTF-8">
<title>Behaviour Report — ${school?.name||'InnoLearn'}</title>
<style>
...
<div class="hdr">
  <div>
    ...
    <div class="sub">${school?.name||'InnoLearn International School'} · ${_periodLabel(_period)} · Generated ${now}</div>
  </div>
  <div style="text-align:right;font-size:12px;color:#6B7280">
    InnoLearn<br>${_termLabel(termId)}
  </div>
</div>
...
<div style="margin-top:28px;padding-top:12px;border-top:1px solid #E5E7EB;font-size:10px;color:#9CA3AF;text-align:center">
  Generated by InnoLearn · ${school?.name||'InnoLearn International School'} · ${now}
</div>
