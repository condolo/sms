  ...
  function _buildReportCardHTML(studentId, termId, classId) {
    ...
    <div class="modal-body" id="rc-print-area">
      <div class="ac-rc-header">
        <div style="font-size:22px;font-weight:800;color:var(--primary)">${school?.name||'Meridian International School'}</div>
      ...
      <div class="ac-rc-footer">Generated by SchoolSync · ${fmtDate(new Date().toISOString())} · ${school?.name}</div>
    </div>`;
  }
