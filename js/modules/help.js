...
const Help = (() => {
  ...
  const ARTICLES = [
    /* ─── Getting Started ─── */
    {
      ...
      content: `
        <p>Open SchoolSync in your browser. Enter your school email address and password, then click <strong>Sign In</strong>.</p>
    ...
    },
    {
      ...
      content: `
        <ul>
          ...
          <li>The <strong>back button</strong> in your browser works normally. SchoolSync uses URL hash routing, so every view has a shareable URL.</li>
    ...
    /* ─── Classes ─── */
    {
      ...
      content: `
        <p>SchoolSync supports four sections: <strong>KG, Primary, Secondary, and A-Level</strong>. Each section contains classes (e.g. Grade 7A).</p>
    ...
    },
    {
      ...
      content: `
        <p>SchoolSync automatically records every critical data change in an internal <strong>audit log</strong>. This happens silently in the background — staff do not need to do anything.</p>
    ...
    },
    {
      ...
      content: `
        ...
        <ul>
          ...
          <li>The file is named <code>schoolsync-backup-YYYY-MM-DD.json</code>.</li>
