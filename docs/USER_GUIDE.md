...
**Version 4.40.0** · Updated 2026-06-23
...
The dashboard only shows cards, charts, and Quick Actions for modules your role can access. A teacher will never see Finance cards; a Finance Officer will not see student-enrolment stats. The sidebar already works this way — the dashboard now follows the same rules.

### Admin / Super Admin / Deputy Principal
- **KPI cards**: total students, staff, attendance rate, fee collection rate
- **Quick Actions grid**: all modules your role can access — Enrol Student, Mark Attendance, Admissions, Finance, HR, Lessons, Reports, and more; each tile shows only when you have permission
- **Recently Enrolled**: latest student enrolments
- **Students by Gender** chart and monthly enrolment trend
- **Upcoming Events**, **Announcements**, and **Birthdays** widgets

### Teacher / Staff
Teachers and staff land on the main `/dashboard` (inside the sidebar shell) — not a separate portal. The teacher view includes:
- **Timetable**: today's lessons with live NOW/NEXT badges
- **Attendance widget**: ring chart of today's register completion for your classes
- **At-risk students**: students in your classes flagged for attendance or behaviour
- **Curriculum coverage**: lesson-plan delivery progress per subject
- **My Classes**: enrolment and quick links per assigned class
- **Form Class**: pastoral summary for classes you are form tutor of
- **Upcoming Exams**: next scheduled assessments for your classes
- **HR panel**: your leave balance and last payslip
- **Departments**: your department membership and HOD
- **Events & Announcements**: school-wide notices

Quick Actions for teachers include Attendance, Timetable, Lessons, Messages — finance and admissions tiles are not shown.

### Finance Officer
- **KPI cards**: fee collection rate, outstanding balance, upcoming invoices
- **Quick Actions**: Finance, Reports — student enrolment cards not shown
