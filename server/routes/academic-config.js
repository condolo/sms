...
const ConfigSchema = z.object({
  ...
  showBehaviour:            z.boolean().optional(),
  showClassTeacherRemark:   z.boolean().optional(),
  showPrincipalRemark:      z.boolean().optional(),
...
function _mergeConfig(saved) {
  return {
    ...
    showBehaviour:              saved?.showBehaviour              ?? DEFAULT_REPORT_CONFIG.showBehaviour,
    showClassTeacherRemark:     saved?.showClassTeacherRemark     ?? DEFAULT_REPORT_CONFIG.showClassTeacherRemark,
    showPrincipalRemark:        saved?.showPrincipalRemark        ?? DEFAULT_REPORT_CONFIG.showPrincipalRemark,
