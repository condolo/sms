...
const WA_MESSAGE = encodeURIComponent('Hi! I\'d like to learn more about Msingi.');
const WA_URL     = `https://wa.me/${WA_NUMBER}?text=${WA_MESSAGE}`;

const SCROLL_THRESHOLD = 300; // px before scroll-to-top appears
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-center gap-3">
      ...
      <a
        ...
        className={[
          'flex items-center justify-center w-13 h-13 rounded-full shadow-lg',
