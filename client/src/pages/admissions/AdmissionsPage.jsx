...
import { UserPlus, Search, X, Download, Upload, Users, TrendingUp, Clock, Star, GraduationCap } from 'lucide-react';
import { admissions as admissionsApi, classes as classesApi } from '@/api/client.js';
...
import { AddStudentSlideOver } from '../students/StudentList.jsx';
...
export default function AdmissionsPage() {
  ...
  /* Class list — needed by AddStudentSlideOver */
      ...
      <AnimatePresence>
        {showEnroll && (
          <AddStudentSlideOver
            ...
            onCreated={() => { setShowEnroll(false); qc.invalidateQueries({ queryKey: ['students'] }); }}
          />
        )}
      </AnimatePresence>
