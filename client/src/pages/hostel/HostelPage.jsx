...
export default function HostelPage() {
  ...
  const createHostel = useMutation({
    ...
    onError: err => toast.error(err?.message ?? 'Failed to create hostel.'),
  });
  const updateHostel = useMutation({
    ...
    onError:    err => toast.error(err?.message ?? 'Failed to update hostel.'),
  });
  const deleteHostel = useMutation({
    ...
    onError: err => toast.error(err?.message ?? 'Failed to delete hostel.'),
  });
  ...
  const deleteRoom = useMutation({
    ...
    onError: err => toast.error(err?.message ?? 'Failed to remove room.'),
  });
  ...
  const discharge = useMutation({
    ...
    onSuccess:  () => {
      ...
      qc.invalidateQueries({ queryKey: ['hostel-rooms'] });
      qc.invalidateQueries({ queryKey: ['hostel-summary'] });
      toast.success('Student discharged from hostel.');
    },
    onError: err => toast.error(err?.message ?? 'Failed to discharge student.'),
  });
