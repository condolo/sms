...
const PORTAL_TIERS_SETTINGS = {
  base:       { label: 'Base',       rate: 250, tagline: 'Admin & teacher portals',   color: 'text-slate-700',  bg: 'bg-slate-50',   border: 'border-slate-300' },
  student:    { label: 'Student',    rate: 300, tagline: 'Base + student portal',      color: 'text-indigo-700', bg: 'bg-indigo-50',  border: 'border-indigo-300', popular: true },
  family:     { label: 'Family',     rate: 350, tagline: 'Student + parent portal',    color: 'text-violet-700', bg: 'bg-violet-50',  border: 'border-violet-300' },
